	...
	public class SeedData
    {
        ...
        public static async Task SeedProperties(ApplicationDbContext ctx)
        {
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Charmig tvåa i på första våningen – med närhet till både natur och centrum! Välkommen till Centralgatan 17F – en trivsam tvåa om 51 smart planerade kvadratmeter i omtyckta Brf Holmsundshus! \r\nHär bor du bekvämt i markplan med ett lugnt läge och fina omgivningar. Perfekt för dig som söker ett lättskött boende med direkt närhet till både service, kommunikationer och grönområden. \r\nLägenheten erbjuder en ljus och inbjudande planlösning där kök och vardagsrum ligger i fil med fint ljusinsläpp. Sovrummet är rymligt nog för både dubbelsäng och förvaring, och ett badrummet som har allt du behöver. \r\nHär finns gott om förvaringsmöjligheter – både i lägenheten och via tillhörande förråd. \r\nBrf Holmsundshus är en välskött och stabil förening med god ekonomi, vilket ger trygghet för dig som köpare. I månadsavgiften ingår det mesta du behöver för ett bekvämt boende. Läget på Centralgatan är svårslaget – du har mataffär, busshållplats och vackra promenadstråk längs vattnet bara några minuter bort. Det här är ett hem att trivas i – lika perfekt för förstagångsköparen som för den som vill bo lättillgängligt och bekymmersfritt!",
                NumberOfRooms = 2,
                MonthlyFee = 3092,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Välkommen till denna välplanerade och rymliga 1:a om 43,5 kvm på populära Mariehem! Här får du en bostad med smart planlösning, gott om förvaring och modern bekvämlighet. \r\nDet luftiga allrummet ger plats för både soffhörna och sovdel, medan det separata köket har bra arbetsytor och förvaring – perfekt för dig som gillar att laga mat. \r\nBadrummet är fräscht och utrustat med dusch och egen tvättmaskin, vilket ger en bekväm vardag utan att behöva nyttja gemensam tvättstuga. \r\nLägenheten ligger i Brf Storspoven, en stabil förening som genomför stora uppgraderingar med fasadrenovering, ventilation och solceller – insatser som både förbättrar boendemiljön och energieffektiviteten. \r\nHär finns även möjlighet att hyra garage- eller parkeringsplats. Läget är utmärkt med närhet till grönområden, mataffärer och goda kommunikationer till centrum. Ett perfekt boende för den som söker en första bostad, studentlägenhet eller en bekväm övernattningslägenhet i ett lugnt och trevligt område.",
                NumberOfRooms = 1,
                MonthlyFee = 3958,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Välkommen till Porfyrvägen 3A – en trivsam och välplanerad etta med närhet till både natur och stad! På omtyckta Gimonäs finner du denna ljusa och stilrena bostad om ett rum och kök, belägen i den välskötta föreningen Brf Cykeln. Här bor du i ett lugnt och trivsamt område med närhet till älven, grönområden, fina cykelvägar samt goda kommunikationer som snabbt tar dig in till centrala Umeå och universitetet. \r\nLägenheten är smart planerad med en välkomnande hall, fräscht kök med plats för matgrupp, ett rymligt allrum med goda möbleringsmöjligheter samt ett helkaklat badrum. \r\nTack vare fönster i bra läge får bostaden ett fint ljusinsläpp som förstärker känslan av rymd. Här finns gott om plats för både vardagsliv och studiero. \r\nBrf Cykeln är en stabil förening med god ekonomi och flera gemensamma bekvämligheter såsom tvättstuga, förråd och cykelförvaring. På Gimonäs bor du nära både natur och service – perfekt för dig som vill ha det bästa av två världar. En perfekt förstaboende, studentlägenhet eller övernattningslägenhet.",
                NumberOfRooms = 1,
                MonthlyFee = 2843,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Välkommen längst upp i huset och denna kvadratsmarta lägenhet på populära Tomtebo. Här får du ett hem med sociala ytor och öppen planlösning mellan kök och vardagsrum, ett stilrent kök som är utrustat med all den maskinella utrustning du kan tänkas behöva. \r\nBadrummet är helkaklat och full-utrustat med egna tvättmöjligheter och golvvärme. God förvaring med skjutgarderob samt extra garderober. Sovalkov som inrymmer dubbelsäng på 180 cm. \r\nBo dessutom i en trevlig och välskött förening på Tomtebo. Området präglas av sina gröna omgivningar och bra kommunikationer. Bussen som stannar strax i närheten tar er till såväl till universitetsområdet som centrala stan inom kort. \r\nHär bor ni dessutom ett stenkast från omtyckta Nydalasjön.",
                NumberOfRooms = 1,
                MonthlyFee = 4250,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Välkommen till Skolgatan 9B – ett drömboende som väntar på dig i Brf Skräddaren 4! Denna charmiga lägenhet i gårdshuset erbjuder en perfekt kombination av stil, komfort och harmoni. \r\nMed 2 rum och kök breder sig det stilfulla hemmet ut över 44 kvadratmeter. Lägenheten erbjuder en mysig och välkomnande atmosfär med balans mellan gammalt och nytt. Huset är ursprungligen från 1920-talet, men hela lägenheten totalrenoverades 2016 med moderna ytskikt. Ljusa och luftiga ytor skapar en harmonisk känsla där du genast kan känna dig hemma. \r\nBrf Skräddaren 4 har ett perfekt läge nära Umeås centrumkärna. Här har du närhet till allt du behöver – allt från grönskande parker, till trendiga caféer och bekväma kommunikationer. \r\nVarför välja mellan stadslivets puls och lugnet i hemmet när du kan ha båda? Föreningen har en mysig gemensam innergård, omsluten av häckar. På innergården finns också ett stort körsbärsträd och pallkragar med möjlighet att odla i. Tvättstuga finns mellan garage och gårdshus. \r\nBostaden har ett genomgående ljust ytskikt, vitpigmenterat ekgolv och vackra spröjsade fönster. Lägenheten har fantastiska detaljer och smarta lösningar som ger dig allt du behöver för att leva bekvämt och njuta av varje ögonblick. \r\nHär möts du av fina hus i ett vackert område, med stadens puls som granne och bekvämt gångavstånd till både centrum och natursköna promenadstråk längs älven. Direkt bussförbindelse samt cykel- och gångvägar till universitet. \r\nSå varför vänta? Ta chansen att bli en del av gemenskapen på Skolgatan 9B och upptäck allt som Brf Skräddaren 4 har att erbjuda. Denna lägenhet har ett lägre andelstal pga annan uppvärmning.",
                NumberOfRooms = 2,
                MonthlyFee = 3442,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Kålhagsvägen 29A erbjuder ett modernt och bekvämt boende i ett naturnära och populärt område. \r\nLägenheten är belägen i Brf Lav Alfa, en välskött förening med byggår 2020 där både fastighet och utemiljö håller hög standard. Här bor du i ett lugnt kvarter med närhet till det mesta – perfekt för både studenter, yrkesverksamma och den som bara vill bo bekvämt. \r\nBostaden är en välplanerad tvåa om 54 kvm med genomtänkta materialval, ljusa ytskikt och smarta förvaringslösningar. Planlösningen är spegelvänd jämfört med liknande lägenheter i huset, vilket ger en egen karaktär till hemmet. Den rymliga balkongen i västerläge bjuder på soliga eftermiddagar och utsikt mot grönska. \r\nLäget är optimalt med gångavstånd till Umeå universitet, Norrlands universitetssjukhus, IKSU sportcenter och flera matbutiker. Endast ett par hundra meter bort ligger Nydalasjön – ett omtyckt rekreationsområde med badplats, motionsspår och vacker natur året om. Goda bussförbindelser tar dig snabbt in till centrum. Brf Lav Alfa är en stabil bostadsrättsförening med låga driftskostnader och moderna bekvämligheter. \r\nHär bor du med det bästa av två världar – nära naturen, men med stadens puls inom räckhåll.",
                NumberOfRooms = 2,
                MonthlyFee = 4790,
                OperationalCostPerYear = 0,
                YearBuilt = 2020,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Stilren och välplanerad trea i populära Brf Hartassen där allt inkl huhållsel ingår i månadsavgiften. \r\nVälkommen till Hermelinvägen 113 – en smakfullt renoverad trea om 79 kvm med genomtänkta materialval, öppen planlösning och ett av föreningens bästa lägen! Här bor du utan hus framför, med fri utsikt mot den grönskande innergården, samtidigt som du har närhet till parkeringarna. Denna bostad erbjuder en harmonisk kombination av stil och funktionalitet med ett modernt kök, smakfullt badrum och ljusa, rymliga rum. Lägenheten ligger i Brf Hartassen, en välskött och stabil förening med gedigen underhållsplan, låga avgifter och utmärkta faciliteter. \r\nLägenheten erbjuder: Rymligt förråd i lägenheten. Modernt kök – stilren inredning med ljusa skåpluckor, svart beslag och betongmönstrad bänkskiva. Här finns gott om förvaring och arbetsytor, samt en praktisk bardel som inbjuder till sociala måltider. Rymligt vardagsrum – ett ljust och inbjudande rum med plats för både matgrupp och soffhörna. Två sovrum – det större rymmer en dubbelsäng och förvaring, medan det andra passar utmärkt som barnrum, kontor eller gästrum. Stilrent badrum – lyxig känsla med glasväggar, stilren kommod, dusch och kombinerad tvätt och torktumlare. \r\nLugnt läge – bostaden ligger insynsskyddad, omgiven av föreningens fina innergårdar.",
                NumberOfRooms = 3,
                MonthlyFee = 4238,
                OperationalCostPerYear = 0,
                YearBuilt = 1974,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Välkommen till denna trivsamma markplanslägenhet på hela 99 kvm i hjärtat av Tomtebo! \r\nHär erbjuds ett bekvämt och funktionellt boende med fyra rum och en social planlösning där köket står i centrum. Köket bjuder in till matlagning och umgänge, perfekt för både vardagsmiddagar och festliga tillfällen. Eftersom det finns uteplatser på både fram och baksida så kan ni njuta av solen både på morgon och kväll. \r\nBostaden bjuder på två uteplatser vilket gör att man både kan fånga morgon och kvällssolen. På baksidan finns också körsbärsträd, vinbärsbuskar och hallon samt en rymlig altan. Lägenheten har tre sovrum, varav ett med en stor klädkammare som ger gott om förvaring. Här får du både komfort och praktiska lösningar för en smidig vardag. Badrummet är funktionellt med tvättmaskin, och dessutom finns en separat toalett som underlättar morgonrutinerna. \r\nDen välskötta bostadsrättsföreningen erbjuder många bekvämligheter för sina boende, såsom ett gym, en avkopplande bastu, hobbyrum, samlingslokal samt en övernattningslägenhet för gäster. För den som har bil finns gott om gästparkeringar, vilket gör det smidigt att ta emot besök. \r\nOmrådet är populärt och lugnt, med närhet till både natur och stadens puls. Här bor du med bekväma kommunikationer och fina grönområden som inbjuder till härliga promenader och friluftsliv. Bara ett stenkast bort ligger Nydalasjön. Ett hem som kombinerar funktion, komfort och en trivsam atmosfär – perfekt för dig som söker ett harmoniskt boende!",
                NumberOfRooms = 4,
                MonthlyFee = 6949,
                OperationalCostPerYear = 0,
                YearBuilt = 0,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Varmt välkomna till Hissjövägen 44! Ett säkert kort bland Umeås föreningar. \r\nHär hittar du ett välskött hem med bekvämt avstånd till stadskärnan och gröna strövområden. Denna trerummare på 53,4 kvadratmeter, belägen på våning två, erbjuder allt du behöver för en bekväm livsstil. Njut av en trivsam balkong med eftermiddags- och kvällssol, perfekt för avkoppling efter en lång dag. Interiört möts du av en välkomnande hall, ett badrum med tvättmaskin och ett fullutrustat kök i öppen planlösning mot sällskapsrummet. De två sovrummen har en sober färgsättning och erbjuder goda förvaringsmöjligheter.  Det finns också ett tillhörande förråd på vinden för extra förvaring. \r\nBRF Kruthornet är en välskött förening med stabil ekonomi, vilket bidrar till en låg månadsavgift och gör detta till ett långsiktigt smart val. Läget är fantastiskt – du har både natur och stad inom räckhåll, med goda kommunikationer som tar dig till både shopping, restauranger och service på kort tid. På bara 15 minuter med kollektivtrafik når du universitetet – en perfekt lösning för den pendlande studenten eller arbetande. \r\nHär finns alla förutsättningar för att trivas riktigt bra! Välkommen att boka din visning!",
                NumberOfRooms = 3,
                MonthlyFee = 3624,
                OperationalCostPerYear = 0,
                YearBuilt = 0,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Charmig tvåa med perfekt läge! Välkommen till denna rymliga tvåa på 69,5 kvm belägen på Kemigränd 14 i en stabil förening. Här möts du av ett fint renoverat kök och ett badrum med tvättmaskin för extra bekvämlighet. Den öppna planlösningen mellan vardagsrum och matplats skapar en inbjudande atmosfär, balkongen erbjuder en plats för avkoppling. \r\nLägenheten ligger nära universitetet, NUS, busshållplats, mataffärer och restauranger, vilket gör den idealisk för både studenter och yrkesverksamma. \r\nFöreningen har en mysig innergård och erbjuder flera bekvämligheter såsom kvarterslokal, gästrum, odlingslotter, tvättstugor och hobbylokaler. Här finns allt du behöver för ett bekvämt och trivsamt boende.",
                NumberOfRooms = 2,
                MonthlyFee = 4424,
                OperationalCostPerYear = 0,
                YearBuilt = 1969,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 226,
                Description = "Välkommen till detta fantastiska radhus i ett populärt område på Tomtebo, bara ett stenkast från Nydalasjön! \r\nDetta hem erbjuder hela 119 kvm av välplanerad yta, byggt 2008, med fyra rymliga sovrum och två helkaklade badrum. Huset har genomgående ljusa ytskikt och parkettgolv som löper vidare genom hela bostaden. På nedre plan finns golvvärme som ger en behaglig och jämn temperatur året runt. Den separata tvättstugan gör vardagen enklare, och de två uteplatserna ger möjlighet till både avkoppling och sociala aktiviteter utomhus. \r\nPå morgonen kan ni njuta av solen på framsidan, medan baksidan erbjuder härlig kvällssol. Eftersom baksidan vetter mot skogen, är det både lugnt och mysigt. Till huset tillhör också en praktisk carport och förråd. \r\nBostaden ligger i en samfällighet där bland annat internet och renhållning ingår. I samfälligheten finns också ett rum som man kan nyttja för att till exempel valla skidorna i.  Området är mysigt och har närhet till både skog och Nydalasjön, vilket skapar en naturnära och harmonisk miljö. \r\nEn bit bort finns också den populära äventyrslekparken.  Dessutom ligger skola och förskolor nära, och det finns bra bussförbindelser som gör det enkelt att ta sig till och från centrum. Perfekt för familjen som söker ett bekvämt och trivsamt boende!",
                NumberOfRooms = 5,
                MonthlyFee = 0,
            ...
            new Property
            {
                ...
                SecondaryArea = 48,
                LotSize = 738,
                Description = "Välkommen till denna trevliga enplansvilla på gaveln, belägen i det natursköna och eftertraktade Holmsund. Här erbjuds ett hem med genomtänkta och praktiska lösningar, perfekt för hela familjen. \r\nVillan har tre sovrum och två badrum, vilket ger gott om utrymme och bekvämlighet i vardagen. De två sällskapsrummen skapar möjligheter för både avkoppling och socialt umgänge. Det vidbyggda garaget och carporten ger smidig parkering och extra förvaringsutrymme. Utanför möts du av en mysig tomt där du kan njuta av lugnet och naturen i denna vackra omgivning. \r\nEtt hem som kombinerar funktionalitet, charm och ett fantastiskt läge – varmt välkommen!",
                NumberOfRooms = 5,
                MonthlyFee = 0,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Välkommen till denna välplanerade 3:a i en populär förening på Ersboda! Här finner du ett renoverat kök med köksö, perfekt för matlagning och sociala tillställningar. \r\nDe rymliga sovrummen har praktiska klädkammare, och badrummet är utrustat med tvättmaskin som underlättar vardagen. Vardagsrummet har en utgång till balkongen, där du kan njuta av en kopp kaffe när solen tittar fram. \r\nFöreningen erbjuder faciliteter såsom en stor samlingslokal, bastu, tvättstugor, hobbyrum, grillplats samt en uthyrningslägenhet för besökare. Här finns också lekplats på innergården. \r\nPå Mjölkvägen 82 bor du nära naturen, skolor, förskolor och butiker – allt för en bekväm och trivsam vardag. Dessutom finns busshållsplats ett stenkast bort som gör det enkelt att ta sig runt stan!",
                NumberOfRooms = 3,
                MonthlyFee = 6392,
                OperationalCostPerYear = 0,
                YearBuilt = 1991,
            ...
            new Property
            {
                ...
                SecondaryArea = 40,
                LotSize = 2269,
                Description = "Magiskt läge vid havet – insynsskyddad oas med panoramautsikt. Välkommen till Sillviken 77 – ett riktigt smultronställe med vidsträckt havsutsikt, sol från morgon till kväll och total avskildhet. \r\nPå den lummiga och lättskötta tomten finns en charmig huvudstuga med nyare kök, uterum, vintervatten och fiber, samt två fräscha gäststugor – samtliga byggnader är i mycket gott skick med moderna ytskikt. Här njuter du av morgonkaffet i soluppgången, kvällsdopp direkt från tomten och närhet till både båtplats och badmöjlighet. En plats att trivas på – året om.",
                NumberOfRooms = 2,
                MonthlyFee = 0,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Välkommen till ett hem som sätter ribban för lyxigt boende! Här bor du i en modern oas byggd 2021, där hissen smidigt tar dig direkt från markplan upp till din egen fristad. \r\nPå sjunde våningen möts du av en en bostad med en ljus och genomtänkt planlösning samt eleganta materialval. Kronan på verket är den stora, inglasade balkongen med en hänförande utsikt över Umeälven – din alldeles egna front row-plats till naturens skådespel. Balkongen badar i sol större delen av dagen och bjuder på magiska kvällar, perfekta för både avkoppling och sociala stunder. Utanför dörren väntar dessutom en vacker strandpromenad längs älvkanten som tar dig hela vägen in till stadens puls. \r\nLägg därtill möjligheten att hyra ett gästrum på markplan, närhet till natur, skolor, universitet och city samt bra bussförbindelser – och du har ett boende som är lika praktiskt som förtrollande. Och när stadens puls kallar? Hoppa på cykeln – på bara fem minuter är du mitt i hjärtat av Umeå. \r\nVarmt välkommen att boka din visning och upptäck en bostad utöver det vanliga!",
                NumberOfRooms = 2,
                MonthlyFee = 4929,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 1900,
                Description = "Varmt välkomna till denna rymliga stuga med åretrunt standard. \r\nStora härliga ytor perfekt för umgänge för familj och vänner men ändå gott om sovrum för övernattande gäster. Stugan har två mysiga kaminer som ger härlig värme. Stort inglasat uterum med stora inredningsmöjligheter. På gården finns  gäststuga även den inredd med mysig kamin. Här har ni huset som ni aldrig behöver oroa er för förvaringen igen.  Det finns stort garage med carport  och gott om förrådsytor samt växthus och fristående uterum. Stor härlig tomt med gräsytor och buskar och fina planteringar. \r\nHär bor ni med gångavstånd till havet samt tillgång till båtplats!",
                NumberOfRooms = 3,
                MonthlyFee = 0,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 1429,
                Description = "Välkommen till detta hemtrevliga och funktionella boende! \r\nDetta välplanerade hem om 100 kvm bjuder på stora, öppna sociala ytor i kök och vardagsrum – perfekta för både vardag och umgänge. Här finner du två mysiga sovrum och ett ljust badrum. För extra värme och mys under kyliga dagar kan du samlas kring inte bara en, utan två kaminer som sprider en ombonad och inbjudande atmosfär genom hela bostaden. Utöver det inbjudande interiören erbjuder bostaden en rymlig gård, perfekt för avkoppling eller odling. Här finns gott om utrymme för att skapa din egen oas, både för lugna stunder och som plats för grönskande projekt. \r\nDetta hem ger verkligen möjlighet till en härlig livsstil, både inomhus och utomhus. Varmt välkommen att boka en visning och upptäck alla fördelar med detta charmiga boende!",
                NumberOfRooms = 3,
                MonthlyFee = 0,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Välkommen till 66,5 välplanerade kvadratmeter som inrymmer allt du behöver - för ett boende över lång tid! \r\nEtt stort vardagsrum med tillgång till härlig balkong i vinkel med magisk utsikt. Köket erbjuder gott om plats för både förvaring och middagssällskap. Lägg där till ett stort sovrum, ett delvis kaklat badrum, rymligt förråd samt en stor klädkammare. Hela lägenheten är ljus och trivsam med en mycket bra planlösning som tar till vara varje kvadratmeter på ett bra sätt. Den stora balkongen bjuder in till mysiga frukostar och sena kvällar med sol från morgon till kväll. Här kan du både tjuvstarta och förlänga sommaren! \r\nPå Kuratorvägen 48 bor du i ett lugnt och framförallt trivsamt område med närhet till både friluftsområden, matvarubutiker, NUS, Universitetet, IKSU samt med bra kommunikationsmöjligheter med buss till centrum och tåg från Umeå Östra station.",
                NumberOfRooms = 2,
                MonthlyFee = 4551,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "I ett omtyckt område, bekvämt belägen på första våningen, hittar ni denna mycket trivsamma och helrenoverade tvåa. \r\nBostaden är utrustad med flera eftertraktade kvaliteter, som en inglasad balkong i söderläge, ett renoverat och välutrustat kök samt ett fräscht badrum med egen tvättmaskin. Här erbjuds också genomgående fina ytskikt, ekparkett och ett härligt ljusinsläpp. Ett väl tilltaget sovrum samt ett vardagsrum som rymmer både soffgrupp och middagsbord ger bostaden en luftig och funktionell känsla. \r\nBrf Biologigränd är en välskött bostadsrättsförening där medlemmarna trivs med de stora, luftiga innergårdarna som erbjuder gemensamma grill-, lek- och sittplatser. \r\nFöreningen har dessutom fina faciliteter såsom gym, biljardrum, pingis, bastu, fritidslokal, gästrum, kompostering och en gästlägenhet. Med låg belåning och förmånligt kollektivt avtal för TV och bredband hålls boendekostnaderna låga. Läget på Biologigränd 37 är suveränt för er som uppskattar närheten till både natur och all nödvändig service. \r\nI Ålidhems centrum finns en välsorterad Ica, apotek, hälsocentral samt ett flertal restauranger. Här bor ni också nära Universitetet, NUS och IKSU. Busshållplats ligger på kort gångavstånd och för er med barn finns flera förskolor och skolor inom bekvämt avstånd.",
                NumberOfRooms = 2,
                MonthlyFee = 3914,
                OperationalCostPerYear = 0,
                YearBuilt = 0,
            ...
            new Property
            {
                ...
                SecondaryArea = 58,
                LotSize = 468,
                Description = "Välkommen till ett ljust och rymligt hem med en genomtänkt planlösning som kombinerar stora, bekväma sovrum med öppna, inbjudande sociala ytor – perfekt för både avkoppling och umgänge. \r\nDet välutrustade köket erbjuder generösa arbetsytor och gott om förvaring, vilket gör matlagningen till en ren glädje – oavsett om det handlar om vardagsmiddagar eller festliga tillställningar. Intill köket ligger det stora och ljusa vardagsrummet, med fantastiskt ljusinsläpp och gott om plats för både soffgrupp och matbord. Härifrån har du dessutom direkt utgång till en härlig altan samt ett trivsamt inglasat uterum – perfekta platser för att njuta av både lugna morgnar och ljumma sommarkvällar. \r\nBostaden rymmer fyra rymliga sovrum och två fräscha badrum, vilket ger gott om plats för både familjen och gäster. Sovrummen är flexibla och kan enkelt anpassas efter dina behov – som barnrum, hemmakontor eller gästrum. De två badrummen underlättar vardagen och gör morgonrutinerna smidigare för hela familjen. Huset erbjuder även mycket bra förvaring. \r\nSnickargatan 10 är beläget i ett lugnt och barnvänligt område med närhet till lekparker, förskola och skola. Här bor du dessutom nära älven och vackra naturområden med fina promenad- och motionsstråk – perfekt för dig som uppskattar friluftsliv och naturens lugn. Med goda bussförbindelser och välutbyggda cykelvägar tar du dig enkelt runt i Umeå, oavsett om du ska till centrum eller andra delar av staden. \r\nVarmt välkommen att boka en visning – upplev själv allt detta trivsamma hem har att erbjuda dig och din familj!",
                NumberOfRooms = 5,
                MonthlyFee = 0,
            ...
            new Property
            {
                ...
                SecondaryArea = 88,
                LotSize = 1174,
                Description = "I början av Antnäs finner du denna 1-plansvilla med källare belägen på stor tomt som angränsar mot grönskande ängar. \r\nPå tomten finns en förrådsbyggnad samt ett nybyggt garage som värms upp med luftvärmepump och har laddning för elbil. Väl inne i huset finns en trivsam hall med plats för avhängning som sedan leder vidare till köket som går i öppen planlösning till vardagsrummet. Köket har träluckor och är fullt utrustad med kombinerad kyl/frys, diskmaskin, spis samt ugn. Matplats ryms invid fönster. Via halvglasad dörr nås altanen med tak ovan. Vidare i huset finns vardagsrummet som har stora fönster som bidrar med gott om ljus till rummet. Här ryms soffa och annat nättare möblemang. \r\nBostaden har i nära anslutning till varann tre sovrum som ligger i fil, i varierande storlekar. Till sist på entréplan finns badrummet, i anslutning till hallen, som renoverats 2016 med våtrumsmatta i neurala kulörer. Här finns både dusch och badkar. I källarplan finns ett stort allrum, som kan nyttjas efter behov, därefter finns mycket plats för förvaring, ett pannrum, matkällare samt en stor tvättstuga/wc. Uppvärmning via bergvärme och vattenburen golvvärme på entréplan. \r\nVillan har bland annat genomgått stora renoveringar som dränering, takbyte, installerat solpaneler på taket samt inkommande servis vatten/avlopp är bytt. Nya rör är även dragna i huset tillsammans med vattenfelsbrytare. Fiber finns indraget. \r\nAntnäs är en populär by med sporthall, skola (F-6), förskolor, elljusspår, matbutik, bensinstation och möbelaffär. Byn har även ett rikt föreningsliv. Närhet till slalombacke och motorbana i Måttsund. \r\nVillan är besiktad via Anticimex och kommer av säljaren försäkras mot dolda fel.",
                NumberOfRooms = 4,
                MonthlyFee = 0,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Välkommen till denna trivsamma 3:a med insynsskyddat och fritt läge på våning 3! \r\nBostaden är i genomgående fint skick med ett smakfullt kök med stilrena köksluckor samt full maskinell utrustning, prydligt badrum och snygga enhetliga golv i grå laminat. \r\nLägenheten består av 70,5 välplanerade kvadratmeter fördelade på ett modernt kök med vita köksluckor och mörk bänkskiva. Här finns gott om förvaring via både över- och underskåp samt en trevlig angränsande matplats med utrymme för ca 4 personer. Rymligt och lättmöblerat vardagsrum med gott om plats för både soffa och annat möblemang samt fint ljusinsläpp via fönster längs med ena väggen. Från vardagsrummet nås också den härliga och väl tilltagna inglasade balkongen i fint solläge och vy över innergården. Bostaden har två stycken ljusa och fina sovrum som båda med enkelhet inrymmer en dubbelsäng samt garderober. Prydligt och tidlöst badrum med stilrena val av kakel. Behaglig golvvärme. \r\nBrf Ränseln är en stor och välskött HSB-förening med bra avgifter och som gjort ett flertal större renoveringar på senare tid där fönster- och balkongbyte nyligen slutförts. \r\nFöreningen erbjuder en samlingslokal som medlemmar får hyra och det finns även en fräsch bastu med relax. Föreningen har även flertalet gemensamma tvättstugor varav två är utrustade med grovtvättmaskiner. \r\nLägenheten disponerar idag ett källarförråd samt en s.k. matkällare som båda finns lättillgängligt belägna i husets källare. Gå gärna in på föreningens hemsida www.hsb.se/norr/brf/ranseln för mer information om föreningens fina utrymmen. Som boende i Brf Ränseln bor du på nära avstånd till butik, bensinstation, restauranger, vårdcentral, tandläkare och med goda bussförbindelser med bland annat en direktlinje till universitet.",
                NumberOfRooms = 3,
                MonthlyFee = 4352,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Välkommen till denna ljusa och moderna gavellägenhet på populära Bergviken! \r\nBostaden är bekvämt belägen en trappa och består av 71,5 välplanerade kvadratmeter fördelade på modernt inrett kök med gott om förvaring tack vare både över- och underskåp samt bra med utrymme för en angränsande matplats invid fönsterparti som ger ett trevligt ljusinsläpp. Rymligt och lättmöblerat vardagsrum med plats för både soffa och annat möblemang. Två fina sovrum, båda i bra storlek samt slutligen ett snyggt badrum med mikrocement. \r\nBrf Snöklockan är en HSB-förening med bra avgifter och fina gemensamma utrymmen såsom tvättstuga, grovtvättstuga, fin bastu med relax samt hobbyrum. Föreningen har både garage samt p-platser med motorvärmare som fördelas enligt separat kö. I källaren finns två lägenhetsförråd varav ett mindre s.k matkällarförråd. \r\nBergviken är ett ständigt populärt område med närhet till både Luleå centrum och Luleå Tekniska Universitet. Närhet till matbutik. Goda bussförbindelser till både centrum och LTU.",
                NumberOfRooms = 3,
                MonthlyFee = 4135,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 0,
                Description = "Välkommen till denna unika och pampiga sekelskifteslägenhet som är genomgående i huset vilket ger ett rikligt ljusinsläpp från de stora höga fönsterna i två väderstreck. \r\nEn rad fina sekelskiftesdetaljer finns bevarade såsom takrosetter, vackra trägolv, djupa fönsterbänkar, en dekorativ kakelugn och framför allt en känsla av rymd med den väl tilltagna takhöjden om ca 2,9 meter. \r\nBostaden består av 86 kvm fördelade på 3 rum varav 1 sovrum, med härliga öppna sällskapsytor med både matsal och vardagsrum. Klassiskt och fint kök med vita köksluckor med överskåp som når hela vägen upp till tak, vilket ger gott om förvaring och förhöjer känslan av den generösa takhöjden. Intill köket finns ett utrymme som i dagsläget nyttjas som kontor och vidare möts man av matsalen där du har utrymme för en större matgrupp för ca 6 personer. Utöver det finns ett helkaklat badrum med tvättmaskin. Från lägenheten nås även en mysig balkong med fint solläge, utöver det har man tillgång till föreningens takterass med en gemensam yta som delas av föreningens medlemmar där utemöbler finns att nyttja. \r\nBRF Sparven 12 är en trivsam förening i en mycket vacker fastighet. På källarplan finns föreningens tvättstuga där även lägenhetens tillhörande förråd finns. Cykelförvaring finns både på entréplan och i källaren. \r\nHär har du chansen att förvärva ett mycket attraktivt boende med ett lugnt men centralt läge med direkt närhet till Luleå centrum med dess restauranger och stadens utbud av butiker. Här har du även närhet till fina promenadstråk samt varvets matvaruhandel!",
                NumberOfRooms = 3,
                MonthlyFee = 4739,
            ...
            new Property
            {
                ...
                SecondaryArea = 0,
                LotSize = 1475,
                Description = "Välkommen till denna fina möjlighet att förvärva ett nybyggt hus med moderna val och en välgenomtänkt planlösning i barnvänliga och gemytliga Kallax! \r\nMycket trivsam och luftig planlösning med plats för den stora familjen med totalt 6 rum varav 5 sovrum. Här erbjuds förutom gott om sovrum även ljusa och väl tilltagna sociala ytor med ett mycket välplanerat kök med stora bänkytor och ett mycket praktiskt skafferi. Invid köket finns utrymme för ett rymligt matbord och vidare i de öppna sociala ytorna finns vardagsrumsdelen där du rymmer en större soffa. Fräscht badrum med fina val av kakel och klinker. Bra planerad klädvårdsavdelning med praktisk groventre. Två av bostadens sovrum återfinns på entréplanet, medan de andra tre sovrummen ligger avskilt till på övre plan tillsammans med ett ljust allrum och ett förberett utrymme för badrum. Det större sovrummet på övre plan har tillgång till en klädkammare. \r\nHär möts du av ett nyckelfärdigt hus om 170 kvm där bara de sista detaljerna finns kvar att färdigställa men där det stora projektet redan är klart så man kan flytta in och börja bo direkt och förädla vidare under tiden. För mer information kontakta ansvarig mäklare.",
                NumberOfRooms = 6,
                MonthlyFee = 0,
